...
case $edition in
    *amd64)
    patchelf --replace-needed libc.so.6 /home/du4t/glibc-all-in-one/libs/$edition/libc.so.6 $1
    patchelf --set-interpreter  /home/du4t/glibc-all-in-one/libs/$edition/ld-linux-x86-64.so.2 $1 
    ;;
    *i386)
    patchelf --replace-needed libc.so.6 /home/du4t/glibc-all-in-one/libs/$edition/libc.so.6 $1
    patchelf --set-interpreter  /home/du4t/glibc-all-in-one/libs/$edition/ld-linux.so.2 $1 
    ;;
esac
exit 0
